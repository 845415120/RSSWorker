...
let deal = async (ctx) => {
	...
	let items = [
		...
		{
			title: 'Your New Dynamic',
			link: 'https://space.bilibili.com/1221413613/dynamic?spm_id_from=333.1365.list.card_title.click',
			description: 'Description of your new dynamic',
			pubDate: new Date().toUTCString(),
			guid: 'https://space.bilibili.com/1221413613/dynamic?spm_id_from=333.1365.list.card_title.click',
			author: 'Your Name',
			category: 'video',
			comments: 'https://space.bilibili.com/1221413613/dynamic?spm_id_from=333.1365.list.card_title.click',
			enclosure: {
